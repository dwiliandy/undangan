...
@section('content')
	<div class="container-fluid">
		<div class="d-flex justify-content-between align-items-center mb-4">
			<div>
				<h2 class="h3 text-gray-800 fw-bold">Create New Event</h2>
				<p class="text-muted small">Start planning your big day.</p>
			</div>
			...
			<div class="row g-4">
				<div class="col-lg-8">
					<div class="card shadow-sm border-0 rounded-3">
						<div class="card-header bg-transparent border-bottom py-3">
							<h5 class="card-title mb-0 fw-semibold text-primary">Event Details</h5>
						</div>
						<div class="card-body p-4">
							...
							<div class="mb-4">
								...
								<div class="form-text small">Use a unique dash-separated text for your invitation link.</div>
							</div>
				...
				<div class="col-lg-4">
					<div class="card shadow-sm border-0 rounded-3 sticky-top" style="top: 20px;">
						<div class="card-header bg-transparent border-bottom py-3">
							<h5 class="card-title mb-0 fw-semibold text-primary">Configuration</h5>
						</div>
						<div class="card-body p-4">
							<div class="mb-4">
							...
							<div class="mb-4">
								<label for="whatsapp_message" class="form-label fw-semibold">WhatsApp Template</label>
								<div class="mb-2">
								...
								<div class="form-text small">Click buttons above to insert placeholders.</div>
							</div>
						</div>
