...
@section('content')
	...
	<!-- Cover Section -->
	<div id="cover"
		class="fixed inset-0 z-50 bg-black flex flex-col justify-center items-center text-center p-8 overflow-hidden font-game text-white">
