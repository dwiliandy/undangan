...
@section('content')
	...
	<!-- Cover (Album Release) -->
	<div id="cover"
		class="fixed inset-0 z-50 bg-[#121212] flex flex-col justify-center items-center text-center p-6 bg-gradient-music overflow-y-auto">

		<div class="m-auto w-full max-w-md py-10">
			<div class="w-64 h-64 shadow-2xl mb-8 relative group mx-auto">
				<!-- Composite Album Art -->
		...
		<div id="main-content"
			class="min-h-screen bg-gradient-to-b from-[#121212] to-[#000] text-white pb-32 relative max-w-md mx-auto shadow-2xl hidden">
